...
public class CaffeineListActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //instruct Android to load a Google Map in our fragment
        SupportMapFragment mapFragment= (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.CaffeinMapFragment);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        for(Location nsaLogs: allLocationsList)
        {
            LatLng loggedLocation= new LatLng(nsaLogs.getLatitude(),nsaLogs.getLongitude());
            mMap.addMarker(new MarkerOptions().position(loggedLocation).title(nsaLogs.getName()));
        }
        //store the references to the google map in our variable
//this method is called after the map is loaded from google play services at this point map is ready
    }
